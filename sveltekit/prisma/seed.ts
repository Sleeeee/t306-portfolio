...
async function main() {
  ...
  const objective1 = await prisma.objectives.create({
    data: {
      name: 'Land a job',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras cursus, massa nec consequat vulputate, tortor nisi consequat urna, quis interdum nulla lectus ut ipsum. Nulla non lectus quis orci faucibus vehicula. Praesent nec nisi augue. Maecenas nec.'
    }
  });
  const objective2 = await prisma.objectives.create({
    data: {
      name: 'Keep learning',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis blandit nisl non malesuada tristique. Aliquam id eleifend arcu. Curabitur venenatis pretium semper. Nullam id orci suscipit, scelerisque urna gravida, condimentum sem. Aenean vel eros lectus. Aliquam nec tortor ut orci lobortis eleifend non.'
    }
  });
  const objective3 = await prisma.objectives.create({
    data: {
      name: 'Contribute',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas elit purus, molestie sit amet justo eget, lacinia sagittis justo. Nullam eu risus quis massa posuere accumsan ut id est. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices.'
    }
  });
