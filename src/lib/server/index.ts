export { createActivity } from './create/createActivity.ts';
export { createDegree } from './create/createDegree.ts'
...
export { deleteDegree } from './delete/deleteDegree.ts';
...
export { editDegree } from './update/editDegree.ts';
...
export { validateColor } from './validators/validateColor.ts';
export { validateDate } from './validators/validateDate.ts';
export { validateId } from './validators/validateId.ts';
export { validateImage } from './validators/validateImage.ts';
export { validateInt } from './validators/validateInt.ts';
export { validateLabels } from './validators/validateLabels.ts';
